#!/usr/bin/env python3
"""Macht aus einem der Kundenpapiere eine druckbare HTML-Seite.
...
def nach_html(md: str, titel: str) -> str:
    """Markdown rein, fertige Seite raus. Zum Drucken gedacht, nicht zum Klicken."""
    return KOPF.format(titel=html.escape(titel)) + bauen(md) + FUSS
